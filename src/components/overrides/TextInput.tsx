...
} from "react-native-paper/src/components/TextInput/Adornment/TextInputAffix";
import TextInputIcon, {
  Props as TextInputIconProps,
} from "react-native-paper/src/components/TextInput/Adornment/TextInputIcon";
import TextInputFlat from "react-native-paper/src/components/TextInput/TextInputFlat";
import TextInputOutlined from "react-native-paper/src/components/TextInput/TextInputOutlined";
import type {
  RenderProps,
  TextInputLabelProp,
} from "react-native-paper/src/components/TextInput/types";
import type { ThemeProp } from "react-native-paper/src/types";
import { forwardRef } from "react-native-paper/src/utils/forwardRef";
import { roundLayoutSize } from "react-native-paper/src/utils/roundLayoutSize";
...
const TextInput = forwardRef<TextInputHandles, Props>(
  (
    ...
    React.useEffect(() => {
      ...
      if (rest.minimize || focused || !rest.label) {
    ...
    }, [focused, rest.label, rest.minimize, rest.placeholder]);
    ...
    React.useEffect(() => {
      ...
      if (rest.minimize || value || focused) {
        // minimize label
    ...
    }, [focused, value, labeled, scale, rest.minimize]);
